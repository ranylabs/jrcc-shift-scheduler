...
const CONTROL_FIELDS = [
  ...
  { key: '--weekday-font-size', label: 'גודל ימי שבוע', type: 'range', min: 8, max: 24, step: 1 },
  { key: '--daynum-font-size', label: 'גודל מספרי ימים', type: 'range', min: 8, max: 24, step: 1 },
